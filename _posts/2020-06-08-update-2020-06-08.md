...
* [medrxivr][] > Access MedRxiv Preprint Data
    ...
    * Issue: [ropensci/onboarding#380](https://github.com/ropensci/software-review/issues/380)
    * Reviewers: not yet assigned
* [coder][] > Deterministic Categorization of Items Based on External Code Data
    * Author: [Erik Bülow](https://github.com/eribul)
    * Issue: [ropensci/onboarding#381](https://github.com/ropensci/software-review/issues/381)
    * Reviewers: not yet assigned
...
* Rodrigues & Boscolo used [taxize][] in their paper [Do bipartite binary antagonistic and mutualistic networks have different responses to the taxonomic resolution of nodes? Ecological Entomology](https://doi.org/10.1111/een.12844) [^3]
...
* Gent _et al_. used [taxize][] in their paper [NULL](https://doi.org/10.1094/phyto-12-19-0448-r) [^6]
...
* Hannah _et al_. used [rgbif][] in their paper [30% land conservation and climate action reduces tropical extinction risk by more than 50%. Ecography](https://doi.org/10.1111/ecog.05166) [^9]
