...
* A new package `vcr` (`v0.1.0`) is on CRAN. `vcr` records HTTP calls to disk. Check out the in progress [http testing book](https://ropensci.github.io/http-testing-book/) to get started. {{ "vcr" | image_cran }} {{ "vcr" | image_github }}
...
* A new version (`v1.0`) of `writexl` is on CRAN, xxx. See the [writexl 
...
[Guangchuang Yu](https://guangchuangyu.github.io/) wrote about his recently onboarded package [treeio][]; see the review at <https://github.com/ropensci/onboarding/issues/179>. [treeio: Phylogenetic data integration](https://ropensci.org/blog/2018/05/17/treeio/)
...
[Evan Odell](https://github.com/evanodell) wrote about his recently onobarded package [nomisr][]; see the review at <https://github.com/ropensci/onboarding/issues/190>. [Nomisr - Access 'Nomis' UK Labour Market Data](https://ropensci.org/technotes/2018/05/08/nomisr/)
...
[Will Landau](https://github.com/wlandau) wrote about the package [drake][]; see the review at <https://github.com/ropensci/onboarding/issues/156>. [drake's improved high-performance computing power](https://ropensci.org/technotes/2018/05/18/drake-hpc/)
