...
[Layik Hama](https://ropensci.org/authors/layik-hama/) and [Robin Lovelace](https://ropensci.org/authors/robin-lovelace/) wrote a summary of their recently onboarded package [stats19][]: [stats19: a package for road safety research](https://ropensci.org/blog/2019/02/26/stats19/). In it, they xxxx.
...
- [rdpla][]: The current maintainer would like to hand it over to someone with more expertise in the domain. Please get in touch with [Scott](mailto:scott@ropensci.org) if you're interested.
